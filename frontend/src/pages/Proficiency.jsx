...
export default function Proficiency() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
      <LoadingOverlay show={loading} message="Loading your proficiency..." />

      <Button variant="ghost" size="sm" className="mb-4" onClick={() => navigate("/dashboard")}>
        <ArrowLeft className="size-4" />
        Back to Dashboard
      </Button>
      <h1 className="text-2xl sm:text-3xl font-bold mb-8">Proficiency</h1>
          ...
          <section key={course.courseId}>
            <div className="flex items-center gap-4 sm:gap-6 mb-6">
              ...
              <div className="min-w-0">
                <h2 className="text-xl sm:text-2xl font-semibold break-words">{course.name}</h2>
